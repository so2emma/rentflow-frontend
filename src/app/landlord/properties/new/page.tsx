...
export default function NewPropertyPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setSuccessMessage('Property created successfully. Redirecting to dashboard...');
      setTimeout(() => {
    ...
    onError: (error: unknown) => {
      ...
      setGlobalError(err.message || 'Failed to create property. Please try again.');
    }
  });
      ...
      >
        <div className="flex flex-col gap-6 max-w-4xl mx-auto mt-6">
          <div className="flex items-center gap-4 border-b border-outline-variant pb-6">
            ...
            <div>
              <h1 className="font-display-md text-headline-md font-bold text-on-surface tracking-tight">Add New Property</h1>
              <p className="text-on-surface-variant font-body-md mt-1">Register a new physical property to your portfolio.</p>
            </div>
          </div>
            ...
            <div className="border-t border-outline-variant pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Field label="Total Units" htmlFor="totalUnits" error={errors.totalUnits}>
                  <input id="totalUnits" name="totalUnits" type="number" min="1" className={INPUT_CLS}
